...
class LocalTaskScreen extends StatefulWidget {
  const LocalTaskScreen({super.key, this.controller, this.analyticsService});
...
class _LocalTaskScreenState extends State<LocalTaskScreen> {
  ...
  void initState() {
    super.initState();
    _controller = widget.controller ?? LocalTaskController();
    _analyticsService = widget.analyticsService ?? LocalAnalyticsService();
    _tasksFuture = _loadTasks();
    _analyticsService.recordEvent(eventName: 'open', featureName: 'local_task');
  }
