...
class _DetailSubjectSchedureState
    extends State<DetailSubjectSchedure> with TickerProviderStateMixin {
  ...
  Widget _buildDayView() {
    return FutureBuilder<List<ThoiKhoaBieu>>(
      ...
      builder: (context, snapshot) {
        ...
        final list = allSchedule.where((item) => item.ngayhoc == todayStr).toList();
          ...
          return Center(
            child: Column(
              ...
              children: [
                ...
                const Text("Không có lịch học hôm nay", style: TextStyle(color: Colors.grey)),
              ],
            ),
          );
        }
