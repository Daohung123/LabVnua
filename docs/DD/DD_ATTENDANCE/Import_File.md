...
|---|---|---|
| ATTENDANCE-CASE-14 | ATTENDANCE-FN01 | QR hợp lệ; hết hạn; sai buổi; quét trùng |
| ATTENDANCE-CASE-15 | ATTENDANCE-FN02 | Roster đủ; chưa xử lý; export buổi/tuần/tháng |
